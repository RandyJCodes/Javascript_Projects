...
const Calculator = {
    // This displays 0
    Display_Value: '0',
    //this will hold the first operand for any expressions. set it to null by default.
    First_Operand: null,
...
// this modifies values each tgime a button is clicked
...
keys.addEventListener('click',(event)=>{
    //The target variable is an object that represents the elemnent
    //that was clicked
    const { target } = event;
